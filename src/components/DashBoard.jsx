...
export function DashBoard({handleAddCarBtnClick, userCarCount, userFavoritesCount, userCarsValue, recentlyAddedCars}){
        ...
        <section>
            <div className={styles.dashBoard}>
                <div className={styles.stats}>
                    ...
                    <StatCard icon={<Star size={40}/>} label="Favorites" value={userFavoritesCount} onClick={()=>toDo("AUTOS FAVORITOS")} pointerCursor/>
